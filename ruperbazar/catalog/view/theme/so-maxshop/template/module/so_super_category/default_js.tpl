		...
		$cat_slider_inner.owlCarousel2({
			...
			responsive: {
				0: {
					...
					nav: (<?php echo count($category_tree) ?> -1 > <?php echo $category_column4;?>) ? true : false
					},
				480: {
					items:<?php echo $category_column2;?> ,
					nav: (<?php echo count($category_tree) ?> -1 > <?php echo $category_column3;?>) ? true : false
					},
				768: {
					items:<?php echo $category_column1;?> ,
					nav: (<?php echo count($category_tree) ?> -1 > <?php echo $category_column2;?>) ? true : false
					},
				992: { items: <?php echo $nb_column1;?> ,
					nav: (<?php echo count($category_tree) ?> -1 > <?php echo $category_column1;?>) ? true : false
					},
				1200: {
					items:<?php echo $category_column0;?> ,
					nav: (<?php echo count($category_tree) ?> -1 > <?php echo $category_column0;?>) ? true : false
					}
			}
		});
		<?php }?>
