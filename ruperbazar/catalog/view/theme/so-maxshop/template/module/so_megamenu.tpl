...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(itemver <= $( ".vertical ul.megamenu >li" ).length)
			$('.vertical ul.megamenu').append('<li class="loadmore"><i class="fa fa-plus-square-o"></i><span class="more-view"> <?php echo $more_text;?></span></li>');
		...
		$(".vertical .megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-plus-square-o"></i><span class="more-view"><?php echo $more_text;?></span>');
			}else{
				...
				$(this).addClass('open');
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-minus-square-o"></i><span class="more-view"><?php echo $close_text;?></span>');
			}
		});
	});
