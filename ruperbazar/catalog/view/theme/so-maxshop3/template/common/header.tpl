...
if ($store_id == 0) {
	...
	$soconfig_toppanel = $config->get('soconfig_toppanel_store');
/* GENERAL */	
	$text_general = array(
		'themelayout',
		'themecolor',
...
<?php if (isset($icon)) { ?><link href="<?php echo $icon; ?>" rel="icon" type="image/x-icon" /><?php } ?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="header-top-right collapsed-block col-lg-8 col-md-7 col-sm-12 col-xs-12 ">
						<h5 class="tabBlockTitle visible-xs"><?php echo $text_more; ?><a class="expander " href="#TabBlock-1"><i class="fa fa-angle-down"></i></a></h5>
						...
						<ul class="top-link list-inline">
							<li class="account" id="my_account"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="btn btn-xs dropdown-toggle" data-toggle="dropdown"> <span><?php echo $text_account; ?></span> <span class="fa fa-angle-down"></span></a>
								<ul class="dropdown-menu ">
									...
									<?php if($soconfig_general["checkout_status"]):?>
