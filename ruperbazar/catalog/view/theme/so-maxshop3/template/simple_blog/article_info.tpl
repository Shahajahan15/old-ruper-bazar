                        ...
                        <div class="article-info">
							...
							<ul class="nav nav-tabs">
								<li class="active">
									<a data-toggle="tab" href="#home">
										...
										<i class="fa fa-facebook-official fa-2x" aria-hidden="true"></i> &nbsp; Comment With Facebook
									</a>
								</li>
							...
							<div class="tab-content">
								<div id="home" class="tab-pane fade in active">
									...
									<div class="fb-comments" data-href="http://localhost/ruperbazar/index.php?route=simple_blog/article/view&simple_blog_article_id=<?php echo $_GET['simple_blog_article_id']; ?>" data-numposts="5"></div>
