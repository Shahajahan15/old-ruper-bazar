												...
												elseif($submenu['content_type'] == '6') {
													if($submenu['productlist']['show_title'] == 1)
														...
														if(isset($submenu['productlist']['products']) && $submenu['productlist']['products']){
															foreach ($submenu['productlist']['products'] as $product) {
															$itempage = (isset($submenu['productlist']['col']) && $submenu['productlist']['col']) ? 12/$submenu['productlist']['col'] : 4;
															echo '<div class="col-sm-'.$itempage.' list-product">';
																echo '<div class="product-thumb">';
																	echo '<div class="image">
																		<a href="'.$product['href'].'">
																			<img src="'. $product['thumb'].'" alt="'. $product['name'].'" title="'. $product['name'].'" class="img-responsive" />
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(itemver <= $( ".vertical ul.megamenu >li" ).length)
			$('.vertical ul.megamenu').append('<li class="loadmore"><i class="fa fa-plus-square-o"></i><span class="more-view"> <?php echo $more_view; ?></span></li>');
		...
		$(".vertical .megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-plus-square-o"></i><span class="more-view"><?php echo $more_view; ?></span>');
			}else{
				...
				$(this).addClass('open');
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-minus-square-o"></i><span class="more-view"><?php echo $more_view_close; ?></span>');
			}
		});
	});
