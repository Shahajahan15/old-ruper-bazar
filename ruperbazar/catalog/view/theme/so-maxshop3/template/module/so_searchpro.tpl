<div id="sosearchpro" class="sosearchpro-wrapper <?php echo $additional_class; ?> compact-hidden collapsed-block">
	<h5 class="tabBlockTitle dropdow-search visible-xs"><?php echo $text_search ;?><a class="expander " href="#TabBlock-search"><i class="fa fa-angle-down"></i></a></h5>
