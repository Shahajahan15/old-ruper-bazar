...
<?php // Begin General CSS ----- ?>
	<?php if($direction=='ltr'):?> <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet"/> <?php endif;?>
	...
	<header id="header" class=" variant<?php echo $header_type; ?>">
				    ...
				    <div class="navbar-logo col-lg-4 col-md-3 col-sm-12 col-xs-12">
					   ...
					   <?php } ?>
						 ...
						 <!-- //end Logo -->
							...
							<?php if ($soconfig_general['searchbox'])?>
					    <div class="col-lg-6 col-md-7 col-xs-12 header_search">
								<?php  echo $content_search; ?>
					    </div>
				     <?php }  ?>
	 
				    <!-- Secondary menu -->
				    <div class="header-center-right col-sm-2">
					...
					<?php
					    if($soconfig_general['phone_status']){
						    if (isset($soconfig_general[$lang]["contact_number"]) && is_string($soconfig_general[$lang]["contact_number"])) {
						     echo '<div class="phone-contact hidden-sm hidden-xs"><div class="inner-info"><h2>Hotline:</h2><p>'.html_entity_decode($soconfig_general[$lang]["contact_number"], ENT_QUOTES, 'UTF-8').'</p></div></div>';
						    } 
					    }
					?>
		...
		<div class="header-bottom">
			...
			<div class="row">
				...
				<!-- Main menu -->
				<div class="header-bottom-menu col-md-10 col-sm-9 col-xs-8">
				     <?php if (trim($content_menu)) :
					echo $content_menu;
				    endif; ?>
				    <!-- //end Navbar -->
				</div>
				<div class="block-cart col-md-2 col-sm-3 col-xs-4">
