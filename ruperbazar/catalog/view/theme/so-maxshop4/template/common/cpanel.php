	...
	<div id="sp-cpanel_settings">
		<div class="panel-group">
			...
			<div class="group-schemes" >
				<span data-scheme="default"  class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="default") ? 'selected' : ''?>"><span style="background: #f8ab16;"></span></span>
				<span data-scheme="blue" class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="blue") ? 'selected' : ''?>"><span style="background: #478bca;"></span></span>
				<span data-scheme="boocdo"  class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="boocdo") ? 'selected' : ''?>"><span style="background: #e54e4e;"></span></span>
				<span data-scheme="cyan" class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="cyan") ? 'selected' : ''?>"><span style="background: #1ea181;"></span></span>
				<span data-scheme="green" class="item_scheme <?php echo (isset($soconfig_general["themecolor"]) && $soconfig_general["themecolor"]=="green") ? 'selected' : ''?>"><span style="background: #52a633;"></span></span>
